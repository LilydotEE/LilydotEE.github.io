    ...
    return function() {
        ...
        1 : [function(b, c, d) { !
            ...
            function() {
                return function(a) {
                    ...
                    b.t = function(a, c) {
                        ...
                        if (b.r(d), Object.defineProperty(d, "default", {
                            enumerable: !0,
                            value: a
                        }), 2 & c && "string" != typeof a) for (var e in a) b.d(d, e,
                        function(b) {
                            return a[b]
                        }.bind(null, e));
                        return d
                        ...
                        u = function() {
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    this._easing = s(u, j);
                                    var v = a.filters;
                                    for (var w in this._filters.length = 0,
                                    v) v[w].doesApply(this) && this._filters.push(v[w]);
                                    return this._applyFilter("tweenCreated"),
                            ...
                            },
                            {
                                key: "pause",
                                value: function() {
                                    if (this._isPlaying) return this._pausedAtTime = a.now(),
                                    this._isPlaying = !1,
                                    t(this),
                                    this
                                }
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    var b = a.now();
                                    return this._pausedAtTime && (this._timestamp += b - this._pausedAtTime, this._pausedAtTime = null),
                                    this._isPlaying = !0,
                                    null === m ? (m = this, n = this,
                                    function a() {
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    f = this._targetState;
                                    if (this._isPlaying) return this._isPlaying = !1,
                                    t(this),
                                    a ? (this._applyFilter("beforeTween"), p(1, c, e, f, 1, 0, d), this._applyFilter("afterTween"), this._applyFilter("afterTweenEnd"), this._resolve(c, b)) : this._reject(c, b),
                                    this
                                }
                            },
                            {
                ...
                function(a, b, c) {
                    ...
                    function e(a) {
                        var b = a._currentState; [b, a._originalState, a._targetState].forEach(z),
                        a._tokenData = C(b)
                    }
                    function f(a) {
                    ...
                    N = function(a, b, c, d) {
                        ...
                        L.set({}), L._currentState = f, L._originalState = a, L._targetState = b, L._easing = g, M) M[i].doesApply(L) && L._filters.push(M[i]);
                        L._applyFilter("tweenCreated"),
                        L._applyFilter("beforeTween");
                        var j = Object(p.e)(c, f, a, b, 1, e, g);
                        return L._applyFilter("afterTween"),
                        j
                    },
                    O = function() {
                        function a() { !
                            ...
                            c = new Array(b), d = 0; d < b; d++) c[d] = arguments[d];
                    ...
                    c.d(b, "setBezierFunction",
                    function() {
                        return Q
                    }),
                    c.d(b, "unsetBezierFunction",
                    function() {
                        return R
                    }),
                    p.a.filters.token = m
        ...
        7 : [function(a, b, c) {
            ...
            g.prototype._createSvgView = function(a) {
                ...
                var c = null; (a.trailColor || a.trailWidth) && (c = this._createTrail(a), b.appendChild(c));
