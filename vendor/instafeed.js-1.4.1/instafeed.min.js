...
(function() {
    ...
    e = function() {
            ...
            if (typeof document != "undefined" && document !== null && this.options.mock === !1) {
                ...
                if (this.options.template != null && typeof this.options.template == "string") {
                    ...
                    for (c = 0, N = m.length; c < N; c++) {
                        ...
                        if (typeof p != "object") throw o = "No image found for resolution: " + this.options.resolution + ".",
                        new Error(o);
                        E = p.width,
                        y = p.height,
                        b = "square",
                    ...
                    while (r < n) i.push(D.childNodes[r]),
                    r += 1;
                ...
                if (_ == null) throw o = 'No element with id="' + this.options.target + '" on page.',
                new Error(o);
                _.appendChild(u),
        ...
        e.prototype._filter = function(e, t) {
            ...
            for (i = 0, o = e.length; i < o; i++) s = e[i],
            r(s);
            return n
        },
        e
